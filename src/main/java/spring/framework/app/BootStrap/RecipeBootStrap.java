package spring.framework.app.BootStrap;

import lombok.extern.slf4j.Slf4j;
import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import spring.framework.app.domain.*;
import spring.framework.app.repositories.CategoryRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootStrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRespository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setPrep_time(10);
        guacRecipe.setCoocking_time(0);
        guacRecipe.setDifficulties(Difficulties.EASY);
        ...
        guacRecipe.getIngredient().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom, guacRecipe));
        ...
        tacosRecipe.setCoocking_time(9);
        tacosRecipe.setPrep_time(20);
        tacosRecipe.setDifficulties(Difficulties.MEDIUM);
        ...
        tacosRecipe.getIngredient().add(new Ingredient("Dried Oregano", new BigDecimal(1), teapoonUom, tacosRecipe));
        tacosRecipe.getIngredient().add(new Ingredient("Dried Cumin", new BigDecimal(1), teapoonUom, tacosRecipe));
        tacosRecipe.getIngredient().add(new Ingredient("Sugar", new BigDecimal(1), teapoonUom, tacosRecipe));
        tacosRecipe.getIngredient().add(new Ingredient("Salt", new BigDecimal(".5"), teapoonUom, tacosRecipe));
        ...
        tacosRecipe.getIngredient().add(new Ingredient("packed baby arugula", new BigDecimal(3), cupsUom, tacosRecipe));
        tacosRecipe.getIngredient().add(new Ingredient("medium ripe avocados, slic", new BigDecimal(2), eachUom, tacosRecipe));
        tacosRecipe.getIngredient().add(new Ingredient("radishes, thinly sliced", new BigDecimal(4), eachUom, tacosRecipe));
        ...
        tacosRecipe.getCategoryNames().add(americanCategory);
        tacosRecipe.getCategoryNames().add(mexicanCategory);
